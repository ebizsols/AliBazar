...
class FCMService {
    ...
    subscribeToTopic = (topic) => {
        messaging().subscribeToTopic(topic)
            .then((res) => {
                ...
                console.log("[FCMService] SubscribeToTopic error ", error)
            })
    }
    ...
    unsubscribeFromTopic = (topic) => {
        messaging().unsubscribeFromTopic(topic)
            .then((res) => {
                ...
                console.log("[FCMService] UnsubscribeFromTopic error ", error)
            })
    }
    ...
    createNotificationKeyListener = (onTokenRefresh, onGetToken) => {
