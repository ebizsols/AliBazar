...
const VerifyPhoneScreen = (props) => {
  ...
  const { requestId, countryCode, mobile } = props.route.params; // data => {"addressId": 57, "errorText": null, "requestId": "60b15f214dce4b5eb54545a387ebfce1", "status": "0"}
  ...
  const verifyMobileNumberAddress = () => {
    if (code === null || code === undefined)
      return;
    setIsLoading(true);
    clientProfile.checkVerifyCustomerMobileNumber(code, screenData.requestId || requestId)
      .then((response) => {
