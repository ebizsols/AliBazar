...
const ProviderTermAndConditionScreen = (props) => {

    const contentWidth = useWindowDimensions().width;

    const { storeName } = props.route?.params;
        ...
        <>
            <ScrollView
                ...
                <View style={styles.closeContainer}>
                    <Text style={styles.title}>{Languages.Common.TermsCondition}</Text>
                ...
                <View>
                    ...
                    <HtmlWebviewRender type={Constants.HtmlWebviewRenderComponentTypes.StoreTerms} storeName={storeName} />
                </View>
            </ScrollView>
        </>
    );
...
export default ProviderTermAndConditionScreen;
