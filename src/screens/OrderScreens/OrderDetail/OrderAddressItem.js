            ...
            <View style={styles.container}>
                ...
                <View style={styles.headerContainer}>
                    <View style={styles.headerLeft}>
                        <Text style={styles.headerLeftText}>{Languages.Order.OrderCapWithTrackingCode(props.trackingCode)}</Text>
                    </View>
                    <View style={styles.headerRight}>
                        {/* <TouchableOpacity onPress={() => true ? props.onMenuPress(props.data) : {}} style={styles.menuIconContainer}>
                            <MenuIcon
